...
using Ecommerce_Website.Areas.AdminPanel.ViewModels.AboutPeople;
using Ecommerce_Website.Areas.AdminPanel.ViewModels.Baner;
...
{
    [Area("AdminPanel")]
    public class HomeSecondSliderController : Controller
    {
        private readonly AppDbContext _context;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public HomeSecondSliderController(AppDbContext context, IWebHostEnvironment environment)
        {
            _context = context;
